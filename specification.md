...
Сервер доступен по адресу: https://15.design.htmlacademy.pro/six-cities.

Спецификация по взаимодействию с сервером в формате OpenAPI — https://15.design.htmlacademy.pro/spec/six-cities.
